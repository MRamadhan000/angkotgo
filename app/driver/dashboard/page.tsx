...
const MapPlaceholder = () => (
  <div className="relative w-full h-[360px] rounded-2xl overflow-hidden bg-[#e8f0e8]">
    ...
    >
      ...
      <path
        d="M 0 310 Q 80 290 160 305 Q 250 320 330 300 Q 420 280 500 295 Q 600 315 700 300 L 760 305"
        fill="none"
        stroke="#aed4e8"
        strokeWidth="18"
        strokeLinecap="round"
      ...
      <text x="415" y="48" fontSize="10" fill="#374151" fontFamily="sans-serif">
        Kota Malang
      </text>
      ...
      <text x="455" y="128" fontSize="12" fontFamily="sans-serif">
        🏛
      </text>
  ...
  return (
    <div className="bg-white p-4 sm:p-6 space-y-5">
          ...
          <div>
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p
                    className={`text-base font-bold ${angkotOn ? "text-green-500" : "text-gray-400"}`}
                  >
                    {angkotOn ? "Beroperasi" : "Tidak Aktif"}
                  </p>
                  <p className="text-xs text-gray-400">
                    {angkotOn
                      ? "Angkot sedang beroperasi"
              ...
              <Toggle
                enabled={angkotOn}
                onChange={() => setAngkotOn(!angkotOn)}
              />
            </div>
          </div>
          <div
            className={`rounded-xl px-4 py-3 flex items-center gap-2 mt-2 ${angkotOn ? "bg-green-50" : "bg-gray-50"}`}
          >
            <svg
              className={`w-4 h-4 flex-shrink-0 ${angkotOn ? "text-green-500" : "text-gray-400"}`}
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <div>
              <p className="text-xs font-medium text-gray-700">
                {angkotOn
                  ? "Angkot Anda sedang beroperasi"
                  : "Angkot Anda tidak aktif"}
              </p>
              <p className="text-[11px] text-gray-400">
                Terakhir aktif: 07:30 WIB
              </p>
            </div>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p
                    className={`text-base font-bold ${penumpangOn ? "text-green-500" : "text-gray-400"}`}
                  >
                    {penumpangOn ? "Available" : "Tidak Tersedia"}
                  </p>
                  <p className="text-xs text-gray-400">
                    {penumpangOn
                      ? "Siap menerima penumpang"
              ...
              <Toggle
                enabled={penumpangOn}
                onChange={() => setPenumpangOn(!penumpangOn)}
              />
            </div>
          </div>
          <div
            className={`rounded-xl px-4 py-3 flex items-center gap-2 mt-2 ${penumpangOn ? "bg-green-50" : "bg-gray-50"}`}
          >
            <svg
              className={`w-4 h-4 flex-shrink-0 ${penumpangOn ? "text-green-500" : "text-gray-400"}`}
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm px-6 py-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-0 md:divide-x md:divide-gray-100">
          <div className="md:pr-6">
            ...
            <span className="inline-block px-2.5 py-1 bg-blue-100 text-blue-700 text-sm font-bold rounded-lg">
              AL
            </span>
          </div>
      ...
      <div className="flex items-center gap-2 py-1 px-1">
        ...
        <p className="text-xs text-gray-400">
          Pastikan status angkot dan penumpang selalu diperbarui untuk
          kenyamanan bersama.
        </p>
      </div>
    </div>
