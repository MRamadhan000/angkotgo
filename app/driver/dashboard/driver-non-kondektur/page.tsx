...
// 2. Widget Kontrol Driver Berbasis Logic Simulasi
function InteractiveDriverWidget({
  ...
  // Initial State: SCHEDULED (Belum Mulai)
  ...
  return (
    <div className="space-y-4 pt-2">
      {/* 1. STATE BILA PENUGASAN SUDAH SELESAI */}
      {tripStatus === AssignmentStatus.COMPLETED ? (
        ...
        /* 2. STATE BELUM MULAI (SCHEDULED) ATAU SEDANG BERJALAN (ONGOING) */
        <>
          ...
          {/* Grid Kursi Penumpang (Hanya muncul jika tripStatus === ONGOING) */}
          {tripStatus === AssignmentStatus.ONGOING && (
  ...
  const MOCK_SCHEDULES: TripHistoryItem[] = [
    {
      assignmentId: 201,
      date: todayStr,
      status: AssignmentStatus.SCHEDULED, // Default Belum Dimulai
      routeCode: "MK-01",
      ...
      <div className="mx-auto max-w-4xl space-y-5">
        ...
        <div className="p-4 bg-blue-50/70 rounded-2xl text-xs text-blue-900 font-medium flex items-center gap-3">
          ...
          <span>
            ...
            kondektur. Anda memiliki akses kontrol penuh perjalanan & kursi
            penumpang.
          </span>
        </div>
          ...
          <div className="space-y-4">
            {activeSchedules.map((item) => (
              ...
              >
                ...
                {/* Interactive Driver Control (Logic Simulasi Demo) */}
                ...
                {completedAssignments.length === 0 ? (
                  <tr>
                    <td colSpan={5} className="p-6 text-center text-slate-400">
                      ...
                      &quot;Selesaikan Perjalanan&quot; di atas untuk
                      mensimulasikan.
                    </td>
                  </tr>
                ) : (
