...
function TarifForm() {
  ...
  return (
    <>
      ...
      {saved && (
        <div
          className="mt-2.5 flex items-center gap-2 bg-green-50 border border-green-200
    ...
    <div className="flex flex-col flex-1 overflow-hidden">
      <main className="flex-1 overflow-y-auto p-5 bg-[#f0f4f8]">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            className="flex items-center gap-2 bg-white border border-slate-200 rounded-[8px]
        ...
        {/* ── Row 1: Stat cards (Interaktif dengan Next Link) ─────────────────── */}
        <div className="grid grid-cols-4 gap-3 mb-3">
          {/* Total Rute -> Menuju halaman route */}
          <Link
          ...
          {/* Total Driver -> Menuju halaman driver */}
          <Link
          ...
          {/* Trayek terbanyak -> Menuju halaman route */}
          <Link
            href="/admin/dashboard/route"
            className="bg-white border border-slate-100 rounded-xl p-4 flex items-start gap-3 transition-all duration-200 hover:scale-[1.015] hover:shadow-sm cursor-pointer"
          >
            ...
            <div>
              ...
              <span
                className="inline-flex items-center gap-1 bg-blue-50 text-blue-600 text-[10px]
        ...
        {/* ── Row 2: Metric + sparkline cards (Interaktif) ───────────── */}
          ...
          {[
            {
              ...
              val: "98",
              unit: "Driver",
              pct: "64.5% dari total driver",
              id: "sp1",
              data: SPARK_DRIVER,
              color: "#16a34a",
              fill: "rgba(22,163,74,.08)",
              targetUrl: "/admin/dashboard/driver",
            },
            {
              title: "Angkot Aktif",
              badge: "● Aktif",
              ...
              val: "86",
              unit: "Angkot",
              pct: "72.9% dari total angkot",
              id: "sp2",
              data: SPARK_AKTIF,
              color: "#2563eb",
              fill: "rgba(37,99,235,.08)",
              targetUrl: "/admin/dashboard/vehicle",
            },
            {
              title: "Angkot Tidak Aktif",
              badge: "● Tidak Aktif",
              badgeCls: "bg-orange-50 text-orange-500",
              val: "32",
              unit: "Angkot",
              pct: "27.1% dari total angkot",
              id: "sp3",
              data: SPARK_NONAKTIF,
              color: "#ea580c",
            ...
            >
              <div className="flex items-start justify-between mb-2">
                ...
                <span
                  className={`text-[10px] font-bold px-2.5 py-0.5 rounded-full ${card.badgeCls}`}
                >
                  {card.badge}
                </span>
              </div>
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <div className="bg-white border border-slate-100 rounded-xl p-4 flex flex-col justify-between">
            ...
            <Link
              href="/admin/dashboard/route"
              className="w-full mt-3 py-2 border border-slate-200 rounded-[8px] text-[12px]
          ...
          <div className="bg-white border border-slate-100 rounded-xl p-4 flex flex-col justify-between">
            ...
            <Link
              ...
              className="w-full mt-4 py-2 border border-slate-200 rounded-[8px] text-[12px]
                                 font-semibold text-blue-600 flex items-center justify-center gap-1.5
                                 hover:bg-slate-50 transition-colors text-center"
            >
