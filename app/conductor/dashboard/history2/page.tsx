...
export default function ConductorFullHistoryPage() {
  const { user } = useAuth();
  ...
  // Data riwayat penugasan dengan Rute Utama - Kota Pasar (MK-01)
  ...
  }, [searchTerm, filterDate, conductorName]);
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 p-4 sm:p-6 lg:p-8 font-sans">
      <div className="mx-auto max-w-6xl space-y-6">
        ...
        <div className="flex items-center justify-between">
          <Link
            href="/conductor/dashboard/driver-kondektur"
        ...
        {/* Table Content - Clean Zebra Striping (Tanpa Border Horizontal) */}
