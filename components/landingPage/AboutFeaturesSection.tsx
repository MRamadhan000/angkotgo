  ...
  return (
    <section className="bg-white py-20">
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-4 lg:items-stretch">
          {/* ===== Column 1 — About ===== */}
          ...
          <div className="relative flex h-[500px] items-center justify-center overflow-hidden rounded-3xl">
            ...
            />
            <div
              className="absolute inset-y-0 left-0 w-full pointer-events-none bg-[linear-gradient(to_right,#fff_0%,#fff_0,15%,rgba(255,255,255,0)_45%)]"
            />
          </div>
          ...
          <div className="flex h-[500px] items-center justify-center rounded-3xl bg-transparent">
            <img
              src="/mobile.png"
              alt="Mobile App"
