// src/components/vehicles/AssignmentInfoCards.tsx
"use client";
...
interface AssignmentInfoCardsProps {
  ...
  isShow?: boolean; // Tambahan prop isShow (opsional, default true)
}

export function AssignmentInfoCards({
  assignmentDetail,
  formattedDate,
  isShow = true,
}: AssignmentInfoCardsProps) {
  // Jika isShow bernilai false, komponen tidak dirender
  if (!isShow) return null;

  return (
    <div className="space-y-3 sm:space-y-4">
      {/* Grid Informasi Utama (Rute, Waktu, Kendaraan) */}
