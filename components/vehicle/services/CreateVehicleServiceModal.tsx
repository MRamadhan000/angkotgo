...
import { CreateVehicleServiceInput } from "@/types/vehicles/vehicle-service.type";
...
interface Props {
  ...
  isLoading?: boolean;
  onClose: () => void;
  onSave: (data: CreateVehicleServiceInput) => void;
}
...
export function CreateVehicleServiceModal({
  vehicleId,
  isOpen,
  isLoading = false,
  onClose,
  ...
  const [form, setForm] = useState<CreateVehicleServiceInput>(
    getInitialForm(vehicleId),
  );
    ...
    onSave({
      ...
      nextServiceOdometer:
        form.nextServiceOdometer != null
          ...
          : undefined,
      nextServiceDate:
        form.nextServiceDate || undefined,
    });
  };
  ...
  const handleClose = () => {
    ...
    setForm(getInitialForm(vehicleId));
    onClose();
  };
        ...
        >
          <div className="p-6 space-y-6">
            ...
            <div>
              ...
              <p className="mt-1.5 text-[11px] text-gray-400">
                Masukkan total biaya yang dikeluarkan untuk
                servis.
              </p>
            </div>
          ...
          <div className="flex items-center justify-between gap-3 px-6 py-4 bg-gray-50 border-t border-gray-100">
            <div className="hidden sm:block">
              <p className="text-[11px] text-gray-400">
                Data servis akan ditambahkan ke kendaraan ini.
              </p>
            </div>
